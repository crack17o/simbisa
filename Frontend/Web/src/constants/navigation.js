...
export const NAV_BY_ROLE = {
  ...
  [ROLES.AGENT]: [
    { to: '/agent', end: true, icon: LayoutDashboard, label: 'Tableau de bord', key: 'nav.dashboard' },
  ...
  [ROLES.MANAGER]: [
    { to: '/manager', end: true, icon: LayoutDashboard, label: 'Supervision', key: 'nav.supervision' },
  ...
  [ROLES.ANALYST]: [
    { to: '/risk', end: true, icon: LayoutDashboard, label: 'Tableau de bord risque', key: 'nav.risk' },
  ...
  [ROLES.ADMIN]: [
    { to: '/admin', end: true, icon: LayoutDashboard, label: 'Administration', key: 'nav.admin' },
  ...
  [ROLES.AUDITOR]: [
    { to: '/audit', end: true, icon: LayoutDashboard, label: 'Audit', key: 'nav.audit' },
